...
if(isset($_POST['ok']) && isset($_SESSION['usuario'])){
...
if(isset($_GET['deletar']) && isset($_SESSION['usuario']) ){
...
<div class="col-lg-8 text-left">
	...
	<table class="table table-bordered table-hover table-responsive">
		...
		<?php do{ ?>
		<tr>
			<td><img width="100%" src="http://rifasbrasil.com.br/<?php echo $banner[ban_imagem]; ?>"></td>
