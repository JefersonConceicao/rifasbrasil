...
if(!isset($_GET['nslots'])){
		...
		if($_POST['layout'] == 5)
			...
			$urlfinal = "http://rifasbrasil.com.br/admin/index.php?p=pdf_multiplo2";
...
function gerar_pagina($get, $parte){
	...
	include("../class/conexao.php");
	    ...
	    exec('wkhtmltopdf -L 0mm -R 0mm -T 0mm -B 0mm --page-width 320mm --page-height 415mm http://rifasbrasil.com.br/admin/resultado/'.$nome.'.html /var/www/html/admin/resultado/'.$nome.'.pdf');
...
for($i = 0; $i < 5; $i++)	
	...
	echo "<a href='http://rifasbrasil.com.br/admin/resultado/".gerar_pagina($_GET, $i)."'>Parte ".($i+1)."</a><br>";
