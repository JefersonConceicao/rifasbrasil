        ...
        <div class="col-lg-6">
            <form id="cadastro" name="cadastro" method="POST"  action="">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="number" pattern="\d*" required name="telefone" value="<?php echo $_SESSION[telefone]; ?>" class="telefone input-lg form-control">
                        </div>
                        <!--
                        <div class="form-group col-lg-6">
                            <label for="">CPF</label>
                        ...
                        <div class="form-group col-lg-12">
                            <button type="submit" name="cadastrar" class="btn-lg btn-success btn">Continuar</button>
