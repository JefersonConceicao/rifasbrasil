...
if(isset($_GET['p'])){
  ...
  if(isset($subpagina[1]) && $subpagina[1] > 0){
...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v3.1&appId=406097183116932&autoLogAppEvents=1';
  fjs.parentNode.insertBefore(js, fjs);
          ...
          <div class="container-fluid col-lg-10 center-block">
            ...
            <div class="navbar-header">
              ...
              <div style="float:left; width: 150px; margin-top: 13px;">
                      ...
                      <a href="index.php?p=inicial"><img src="img/logotipo_NAO.png" alt="" class="img-responsive"></a>
    ...
    <section class="rodape">
        ...
        <div class="col-md-12 text-center col-lg-10 center-block">
          ...
          <p><img src='http://contador.s12.com.br/img-bDZwzzdb-3.gif' border='0' alt='contador'><script type='text/javascript' src='http://contador.s12.com.br/ad.js?id=bDZwzzdb'></script> visitas</p><p> 2018 - Todos os direitos reservados</p>
