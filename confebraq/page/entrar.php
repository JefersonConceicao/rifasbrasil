...
if(isset($_GET[reenviar])){
    mail($_GET[reenviar], "Valide sua conta", "Olá\n\nClique no link para validar sua conta: http://rifasbrasil.com.br/confebraq/index.php?p=validar&cod=".$_GET[cod]."&email=".$_GET[reenviar]."\n\nAtenciosamente,\nCONFEBRAQ");          
}
...
mail($_SESSION[email], "Valide sua conta", "Olá\n\nSua conta foi criada com sucesso. Clique no link para validar sua conta: http://rifasbrasil.com.br/confebraq/index.php?p=validar&cod=".md5($usuario)."&email=".$_SESSION[email]."\n\nAtenciosamente,\nCONFEBRAQ");
