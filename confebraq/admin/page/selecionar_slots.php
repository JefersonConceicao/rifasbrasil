...
<div class="col-lg-12 col-md-12">
	...
	<form id="varias_rifas" action="http://52.67.27.97/new_server/index.php" method="get">
	<div  class="form-group col-lg-12 col-md-12">
		...
		<form style="display:none;" id="rifa_unica" action="http://52.67.27.97/new_server/index.php" method="get">
