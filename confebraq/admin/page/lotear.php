...
$rifas_usuario = db_select($mysqli, "select rifa_cod, rifa_titulo, rifa_valorbilhete, rifa_maxbilhetes from tbl_rifas where rifa_dono = '$_SESSION[usuario]' and rifa_deletada is null ");
		...
		<body>
			...
			<tr>
				...
				<td>
					...
					<small><label for="">Rifa</label></small>
