...
<div class="col-lg-12">
	...
	if(count($erro) > 0){
		...
		echo "<script>alert('Atualizado com sucesso!');</script><div class=\"col-lg-12\"><a href='http://rifasbrasil.com.br/confebraq/admin/index.php?p=rifa'>Clique aqui</a> para voltar.</div>";
