  ...
  <section class="section-default" id="destaque">
    ...
    <div class="col-lg-10 center-block"><b>Detalhes da Rifa</b><hr>
     ...
     <div class="col-lg-4">
      ...
      <a target="_blank" href="http://rifasbrasil.com.br/<?php echo $rifa['rifa_foto1']; ?>">

      <img src="http://rifasbrasil.com.br/<?php echo $rifa['rifa_foto1']; ?>" alt="" class="img-responsive img-thumbnail">
      ...
      <a target="_blank" href="http://rifasbrasil.com.br/<?php echo $rifa[rifa_foto2]; ?>">

      <img src="http://rifasbrasil.com.br/<?php echo $rifa[rifa_foto2]; ?>" alt="" class="img-responsive col-lg-3 img-rifa img-thumbnail">
      ...
      <a target="_blank" href="http://rifasbrasil.com.br/<?php echo $rifa[rifa_foto3]; ?>">

      <img src="http://rifasbrasil.com.br/<?php echo $rifa[rifa_foto3]; ?>" alt="" class="img-responsive col-lg-3 img-rifa img-thumbnail">
    ...
    <div class="col-lg-3">
      ...
      <div class="col-lg-3">
        ...
        <?php if(intval($rifa[rifa_finalizar]) == 0 && strtotime($rifa[rifa_dtsorteio]." 23:59:59") > time()) { ?>
