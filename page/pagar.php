...
if($compra > 0){
    ...
    $sql_rifa = "SELECT * FROM tbl_bilhetes b, tbl_rifas r, tbl_usuario u 
    WHERE u.usu_cod = r.rifa_dono 
    and b.bil_compra = '$compra' 
    AND r.rifa_cod = b.bil_rifa";

    $qrifa = $mysqli->query($sql_rifa) or die($mysqli->error);
    $rifa = $qrifa->fetch_assoc();

    $dono = $mysqli->query("select usu_email from tbl_usuario where usu_cod = '".$rifa['rifa_dono']."'") or die($mysqli->error);
    $dono = $dono->fetch_assoc();
...
action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
        ...
        <input name="itemDescription<?php echo $i; ?>" type="hidden" value="Bilhete <?php echo str_pad($rifa[bil_numero], 3, "0", STR_PAD_LEFT); ?> | Compra nº #<?php echo $compra; ?>">  
...
src="https://p.simg.uol.com.br/out/pagseguro/i/botoes/pagamentos/120x53-pagar.gif"/> 
    ...
    <div class="col-lg-6 ">
        <div class="col-lg-10">
                 ...
                 <?php } ?>
                 <p></p>
                 <p>Ao efetuar o depósito. Envie um e-mail para <strong><?php echo $dono['usu_email']; ?></strong> com o comprovante.</p>
            </div>
